...
const ListEntryHeader = (props) => {
  ...
  return (
    <div className="row" style={{ marginBottom: '5px' }}>
      ...
      <div className="col-3 col-md-2">
        <span className="badge badge-default badge-pill">{politicianExtraData.score}</span>
        <a
          data-toggle="collapse"
          data-parent="#accordion"
          href={`#collapse${index}`}
...
const ListEntryExpandable = (props) => {
  ...
  return (
    <div id={`collapse${index}`} className={classNames} role="tabpanel" aria-labelledby="headingOne">
            ...
            <div className="col-12 col-md-8">
              ...
              <div className="card">
                <div className="card-header">
                  <div className="row">
                    <div className="col-8"><h4>{official.name}</h4></div>
                    {score &&
                ...
                <div className="card-block">
                  <p className="card-text">
                    {official.photoUrl &&
                      <img style={{ width: '150px', padding: '0px 15px 0px 0px' }} align="left" src={official.photoUrl} alt="Card image cap" />
                    }
                    <p><b>{actionNotes}</b></p>
                    {yimbyMailerLink &&
                ...
                <div className="card-block row">
                  ...
                  {twitter && twitter.id &&
                    <div className="card-block-item col-12 col-md">
                      <a href={`https://twitter.com/${twitter.id}`} target="_blank" className="card-link">
                        @{twitter.id}
                      </a>
                    </div>
                  }
